...
for file in (os.listdir("/g/data/ux62/access-s2/hindcast/raw_model/atmos/pr/daily/e06/")):
    ds_raw = xr.open_dataset("/g/data/ux62/access-s2/hindcast/raw_model/atmos/pr/daily/e06/" + file) * 86400
    ...
    # save to netcdf
    ds_total.to_netcdf("/scratch/iu60/rh4668/processed_data_mask/e06/" + file)
    ds_raw.close()
