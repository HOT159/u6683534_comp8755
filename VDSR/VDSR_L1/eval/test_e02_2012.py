...
def getitem(idx,leading):
    ...
    filename = "/scratch/iu60/rh4668/test_data/2012/e02/da_pr_" + idx.strftime("%Y%m%d") + "_e02.nc"
...
with torch.no_grad():
    rootdir="/scratch/iu60/rh4668/test_data/2012/e02/"
    start_date=date(2012,1,1)
    end_date=date(2012,12,31)
    files=get_time_without_en("/scratch/iu60/rh4668/test_data/2012/",start_date,end_date)
    files.sort()
    for t in files:
        fn=rootdir  +"da_pr_" + t.strftime("%Y%m%d") + "_e02.nc"
        ...
        save_path="/scratch/iu60/rh4668/VDSR/eval/2012/e02/" + t.strftime("%Y%m%d")  + ".nc"
