...
class param_args():
    ...
    def __init__(self):
        ...
        self.lr           = 0.000090             # learning rate
...
#         self.upscale_factor= 4
        ...
        self.test_end_time    =date(2012,6,30)
...
class trainer():
    ...
    def main(self):
        ...
        model=RFDNX4X2()
        #model=torch.load('/scratch/iu60/rh4668/Train_RFDN_L2/Train/save/RFDNX4X2model_epoch_10.pth',map_location=self.args.device)['model']
        ...
        for epoch in range(start_epoch, self.args.nEpochs + 1):
            ...
            for iteration, (pr,hr,_,_) in enumerate(train_dataloders):
                ...
                out=torch.nn.functional.interpolate (out_ensemble,size=(691,886),mode='bilinear', align_corners=True)
                #print(out.shape)
